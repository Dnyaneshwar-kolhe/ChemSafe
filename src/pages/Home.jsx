  ...
  return (
    <div className="home-container-wrapper">
      ...
      <div className="home-container">
        ...
        <div className="home-image">
          <img src="chemfact.jpg" alt="ChemSafe Industries" />
        </div>
      </div>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-section company-info">
            <img
              src="https://sdmntprnorthcentralus.oaiusercontent.com/files/00000000-b3a4-622f-bf6c-9d8dae4b2e5d/raw"
              alt="ChemSafe Industries"
              className="logo"
            />
            <p>chemsafe.industries@gmail.com</p>
          ...
          <div className="footer-section quick-links">
            ...
            <ul>
              ...
              <li><Link to="/alerts">Product Expiry Alerts</Link></li>
